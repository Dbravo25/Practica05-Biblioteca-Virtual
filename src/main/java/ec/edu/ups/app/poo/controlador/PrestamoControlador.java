...
public class PrestamoControlador {
    ...
    public void create( int numPrestamo, Date fechaPrestamo, Date fechaDevolucion){
        prestamo = new Prestamo(numPrestamo, fechaPrestamo, fechaDevolucion);
    ...
    public void update(int numPrestamo, Date fechaPrestamo, Date fechaDevolucion){
        prestamo = new Prestamo(numPrestamo, fechaPrestamo, fechaDevolucion);
